function addProbeAndOrganize(modelName, modulePath, probeSignals)
    ...
    set_param(probeName, 'Position', [modulePos(3)+250 modulePos(2) modulePos(3)+330 modulePos(2)+max(50,numel(probeSignals)*25)]);
