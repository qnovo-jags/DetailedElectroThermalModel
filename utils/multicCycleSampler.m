function currentCycle = multicCycleSampler(Qnom, numParallelCells, samplingFrequency, RestTime0, RestTime1, chargeRate, RestTime2, dischargeRate, RestTime3, numChargeCycles, ...
